...
max_evidence_age_sec="${PROD_PILOT_COHORT_QUICK_ALERT_MAX_EVIDENCE_AGE_SEC:-${PROD_PILOT_COHORT_QUICK_TREND_MAX_EVIDENCE_AGE_SEC:-${PROD_PILOT_COHORT_QUICK_CHECK_MAX_EVIDENCE_AGE_SEC:-600}}}"
