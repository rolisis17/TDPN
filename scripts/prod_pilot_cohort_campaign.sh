...
signoff_max_evidence_age_sec="${user_signoff_max_evidence_age_sec:-${PROD_PILOT_COHORT_CAMPAIGN_QUICK_SIGNOFF_MAX_EVIDENCE_AGE_SEC:-${PROD_PILOT_COHORT_QUICK_SIGNOFF_MAX_EVIDENCE_AGE_SEC:-600}}}"
...
campaign_signoff_max_evidence_age_sec="${user_campaign_signoff_max_evidence_age_sec:-${PROD_PILOT_COHORT_CAMPAIGN_SIGNOFF_MAX_EVIDENCE_AGE_SEC:-${PROD_PILOT_COHORT_CAMPAIGN_CHECK_MAX_EVIDENCE_AGE_SEC:-600}}}"
