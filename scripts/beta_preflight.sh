...
run_step "access recovery demo contract" bash ./scripts/integration_access_recovery_demo_contract.sh
run_step "access recovery examples contract" bash ./scripts/integration_access_recovery_examples_contract.sh
...
run_step "windows desktop installer guardrails integration" ./scripts/integration_windows_desktop_installer_guardrails.sh
...
run_step "replay redis-mode integration" ./scripts/integration_replay_redis_mode.sh
...
run_step "web home contract" ./scripts/integration_web_home_contract.sh
