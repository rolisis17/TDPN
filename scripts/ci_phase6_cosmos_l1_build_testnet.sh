...
canonical_summary_json="${CI_PHASE6_COSMOS_L1_BUILD_TESTNET_CANONICAL_SUMMARY_JSON:-$ROOT_DIR/.easy-node-logs/phase6_cosmos_l1_build_testnet_ci_summary.json}"
...
echo "[ci-phase6-cosmos-l1] canonical_summary_json=$canonical_summary_json"
