...
HOME_HTML_MARKERS=(
  ...
  'class="[^"]*hero-badges'
  'id="why-recovery-heading"'
  'class="[^"]*product-card'
  'id="beta-flow-heading"'
  'class="[^"]*recovery-flow-grid'
  'id="bridge-paths-heading"'
  'id="operator-evidence-heading"'
  'class="[^"]*server-preview-card'
  'id="trust-heading"'
  'id="recovery-cta-heading"'
  'class="[^"]*cta-panel'
  'href="./recovery.html"'
  'href="./portal.html"'
)
...
HOME_CSS_MARKERS=(
  ...
  '\.product-card'
  '\.page-home[[:space:]]+\.recovery-flow-grid'
  '\.page-home[[:space:]]+\.recovery-flow-node'
  '\.server-preview-card'
  '\.reveal--1[[:space:]]*\{'
  '\.reveal--4[[:space:]]*\{'
