...
Purpose:
  Run the Phase-6 Cosmos L1 contracts CI gate in deterministic order:
    ...
    3) integration_phase6_cosmos_l1_build_testnet_check.sh
    4) integration_phase6_cosmos_l1_build_testnet_run.sh
    5) integration_phase6_cosmos_l1_build_testnet_handoff_check.sh
    6) integration_phase6_cosmos_l1_build_testnet_handoff_run.sh
    7) integration_phase6_cosmos_l1_build_testnet_suite.sh
