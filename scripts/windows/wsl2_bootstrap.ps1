...
if ($Distro -ne "") {
  Write-Host "wsl -d $Distro -- bash -lc \"cd $repoRootWslQuoted; ./bin/privacynode-easy\""
} else {
  Write-Host "wsl -- bash -lc \"cd $repoRootWslQuoted; ./bin/privacynode-easy\""
}
