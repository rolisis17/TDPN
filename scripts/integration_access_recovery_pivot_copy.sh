...
require_phrase README.md 'Pilot-ready verifier receipts must use schema minor `4` or newer'
...
require_phrase docs/access-recovery-toolkit-track.md 'Pilot-ready verifier receipts must use schema minor `4` or newer'
