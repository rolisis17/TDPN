...
require_campaign_signoff_attempted="${PROD_PILOT_COHORT_CAMPAIGN_SIGNOFF_REQUIRE_CAMPAIGN_SIGNOFF_ATTEMPTED:-1}"
require_campaign_signoff_ok="${PROD_PILOT_COHORT_CAMPAIGN_SIGNOFF_REQUIRE_CAMPAIGN_SIGNOFF_OK:-1}"
require_campaign_signoff_enabled="${PROD_PILOT_COHORT_CAMPAIGN_SIGNOFF_REQUIRE_CAMPAIGN_SIGNOFF_ENABLED:-${PROD_PILOT_COHORT_CAMPAIGN_CHECK_REQUIRE_CAMPAIGN_SIGNOFF_ENABLED:-1}}"
require_campaign_signoff_required="${PROD_PILOT_COHORT_CAMPAIGN_SIGNOFF_REQUIRE_CAMPAIGN_SIGNOFF_REQUIRED:-${PROD_PILOT_COHORT_CAMPAIGN_CHECK_REQUIRE_CAMPAIGN_SIGNOFF_REQUIRED:-1}}"
require_campaign_signoff_summary_json="${PROD_PILOT_COHORT_CAMPAIGN_SIGNOFF_REQUIRE_CAMPAIGN_SIGNOFF_SUMMARY_JSON:-1}"
require_campaign_signoff_summary_json_valid="${PROD_PILOT_COHORT_CAMPAIGN_SIGNOFF_REQUIRE_CAMPAIGN_SIGNOFF_SUMMARY_JSON_VALID:-1}"
require_campaign_signoff_summary_status_ok="${PROD_PILOT_COHORT_CAMPAIGN_SIGNOFF_REQUIRE_CAMPAIGN_SIGNOFF_SUMMARY_STATUS_OK:-${PROD_PILOT_COHORT_CAMPAIGN_CHECK_REQUIRE_CAMPAIGN_SIGNOFF_SUMMARY_STATUS_OK:-1}}"
require_campaign_signoff_summary_final_rc_zero="${PROD_PILOT_COHORT_CAMPAIGN_SIGNOFF_REQUIRE_CAMPAIGN_SIGNOFF_SUMMARY_FINAL_RC_ZERO:-${PROD_PILOT_COHORT_CAMPAIGN_CHECK_REQUIRE_CAMPAIGN_SIGNOFF_SUMMARY_FINAL_RC_ZERO:-1}}"
...
max_evidence_age_sec="${PROD_PILOT_COHORT_CAMPAIGN_SIGNOFF_MAX_EVIDENCE_AGE_SEC:-${PROD_PILOT_COHORT_CAMPAIGN_CHECK_MAX_EVIDENCE_AGE_SEC:-600}}"
