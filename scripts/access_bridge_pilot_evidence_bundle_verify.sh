  ...
  semantic_errors="$(jq -nr \
    ...
    --arg expected_require_mtls "$expected_require_mtls" '
      ...
      | [
          ...
          if schema_ok($s; "access_bridge_service_smoke_summary"; (if $expected_require_mtls == "true" then 5 else 3 end)) | not then "bundled service smoke summary schema is invalid or too old" else empty end,
          ...
          if schema_ok($d; "access_bridge_deployment_evidence_summary"; (if $expected_require_mtls == "true" then 4 else 2 end)) | not then "bundled deployment evidence summary schema is invalid or too old" else empty end,
