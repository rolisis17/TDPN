...
if ! jq -e '
  ...
  and (.checks.toolchain.npx_available | type == "boolean")
  and (.checks.toolchain.npx_path | type == "string")
  ...
  and (.checks.npm | type == "object")
  and (.checks.npm.resolves_to_npx_ps1 | type == "boolean")
  and (.checks.npm.npx_cmd_sibling_available | type == "boolean")
  and (.checks.npm.npx_cmd_sibling_path | type == "string")
  and (.checks.npm.npx_ps1_policy_issue | type == "boolean")
  and (.checks.npm.npx_ps1_without_npx_cmd | type == "boolean")
  and (.checks.npm.session_alias_remediation | type == "object")
  and (.checks.npm.session_alias_remediation.npm | type == "object")
  and (.checks.npm.session_alias_remediation.npm.eligible | type == "boolean")
  and (.checks.npm.session_alias_remediation.npm.attempted | type == "boolean")
  and (.checks.npm.session_alias_remediation.npm.applied | type == "boolean")
  and (.checks.npm.session_alias_remediation.npm.reason | type == "string")
  and (.checks.npm.session_alias_remediation.npm.alias_definition | type == "string")
  and (.checks.npm.session_alias_remediation.npm.error | type == "string")
  and (.checks.npm.session_alias_remediation.npx | type == "object")
  and (.checks.npm.session_alias_remediation.npx.eligible | type == "boolean")
  and (.checks.npm.session_alias_remediation.npx.attempted | type == "boolean")
  and (.checks.npm.session_alias_remediation.npx.applied | type == "boolean")
  and (.checks.npm.session_alias_remediation.npx.reason | type == "string")
  and (.checks.npm.session_alias_remediation.npx.alias_definition | type == "string")
  and (.checks.npm.session_alias_remediation.npx.error | type == "string")
