...
assert_phase5_block "$DIRECT_SUMMARY_JSON" "$PHASE5_HANDOFF_SUMMARY_JSON" "$PHASE5_HANDOFF_SUMMARY_JSON" "handoff" "pass" "0" "true" "true" "false" "true" "pass" "true"
...
assert_phase5_block "$NESTED_SUMMARY_JSON" "$PHASE5_RUN_SUMMARY_JSON" "$PHASE5_CHECK_SUMMARY_JSON" "check" "warn" "7" "false" "true" "true" "false" "null" "null"
...
assert_phase5_block "$FALLBACK_SUMMARY_JSON" "$FALLBACK_SOURCE_JSON" "$FALLBACK_SOURCE_JSON" "check" "pass" "0" "true" "false" "false" "true" "pass" "true"
...
assert_phase5_block "$FALLBACK_COMPLETE_PREFERRED_SUMMARY_JSON" "$PHASE5_COMPLETE_FALLBACK_JSON" "$PHASE5_COMPLETE_FALLBACK_JSON" "handoff" "pass" "0" "true" "true" "false" "true" "pass" "true"
