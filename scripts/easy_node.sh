...
Notes:
  ...
  - profile-compare-multi-vm-stability-promotion-cycle runs repeated multi-VM stability cycles and then executes promotion-check on the generated cycle-summary list.
  ...
  - profile-default-gate-stability-promotion-cycle runs repeated profile-default-gate stability cycles and then executes promotion-check on the generated cycle-summary list.
