...
Usage:
  ...
  ./scripts/easy_node.sh profile-default-gate-live [--host-a HOST|--directory-a HOST_OR_URL|--directory-a-url URL] [--host-b HOST|--directory-b HOST_OR_URL|--directory-b-url URL] [--campaign-subject INVITE_KEY|--subject INVITE_KEY|--key INVITE_KEY|--invite-key INVITE_KEY] [--allow-remote-http-probe [0|1]] [--heartbeat-interval-sec N] [--campaign-live-evidence [0|1]] [profile-default-gate-run args...]
./scripts/easy_node.sh profile-default-gate-stability-run --host-a HOST --host-b HOST [--campaign-subject ID|--subject ID] [--runs N] [--campaign-timeout-sec N] [--campaign-live-evidence [0|1]] [--allow-remote-http-probe [0|1]] [--sleep-between-sec N] [--reports-dir DIR] [--summary-json PATH] [--print-summary-json [0|1]] [--allow-partial [0|1]]
  ...
  ./scripts/easy_node.sh profile-default-gate-stability-cycle --host-a HOST --host-b HOST [--campaign-subject ID|--subject ID] [--runs N] [--campaign-timeout-sec N] [--campaign-live-evidence [0|1]] [--allow-remote-http-probe [0|1]] [--sleep-between-sec N] [--reports-dir DIR] [--stability-summary-json PATH] [--stability-check-summary-json PATH] [--summary-json PATH] [--print-summary-json [0|1]] [--fail-on-no-go [0|1]]
