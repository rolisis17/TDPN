...
Usage:
  ...
  ./scripts/easy_node.sh access-recovery-real-helper-evidence-run [--roadmap-refresh 0|1] [access_recovery_real_helper_evidence_run args...]
  ...
  ./scripts/easy_node.sh profile-default-gate-run [--directory-a HOST_OR_URL|--host-a HOST_OR_URL] [--directory-b HOST_OR_URL|--host-b HOST_OR_URL] [--campaign-subject INVITE_KEY|--subject INVITE_KEY] [--heartbeat-interval-sec N] [--allow-remote-http-probe [0|1]] [--campaign-profiles CSV] [profile-compare-campaign-signoff args...]
  ./scripts/easy_node.sh profile-default-gate-live [--host-a HOST|--directory-a HOST_OR_URL|--directory-a-url URL] [--host-b HOST|--directory-b HOST_OR_URL|--directory-b-url URL] [--campaign-subject INVITE_KEY|--subject INVITE_KEY|--key INVITE_KEY|--invite-key INVITE_KEY] [--allow-remote-http-probe [0|1]] [--heartbeat-interval-sec N] [--campaign-runs N] [--campaign-profile-rounds N] [--campaign-profile-timeout-sec N] [--campaign-execution-mode docker|local] [--campaign-live-evidence [0|1]] [--require-external-live-evidence [0|1]] [--campaign-live-evidence-udp-inject [0|1]] [profile-default-gate-run args...]
  ./scripts/easy_node.sh profile-default-gate-stability-run --host-a HOST --host-b HOST [--campaign-subject ID|--subject ID] [--runs N] [--campaign-timeout-sec N] [--campaign-runs N] [--campaign-profile-rounds N] [--campaign-profile-timeout-sec N] [--campaign-require-min-runs-total N] [--campaign-require-min-runs-with-summary N] [--campaign-require-trend-source CSV] [--campaign-execution-mode docker|local] [--campaign-live-evidence [0|1]] [--require-external-live-evidence [0|1]] [--campaign-live-evidence-udp-inject [0|1]] [--allow-remote-http-probe [0|1]] [--sleep-between-sec N] [--reports-dir DIR] [--summary-json PATH] [--print-summary-json [0|1]] [--allow-partial [0|1]]
  ...
  ./scripts/easy_node.sh profile-default-gate-stability-cycle --host-a HOST --host-b HOST [--campaign-subject ID|--subject ID] [--runs N] [--campaign-timeout-sec N] [--campaign-runs N] [--campaign-profile-rounds N] [--campaign-profile-timeout-sec N] [--campaign-require-min-runs-total N] [--campaign-require-min-runs-with-summary N] [--campaign-require-trend-source CSV] [--campaign-execution-mode docker|local] [--campaign-live-evidence [0|1]] [--require-external-live-evidence [0|1]] [--campaign-live-evidence-udp-inject [0|1]] [--allow-remote-http-probe [0|1]] [--sleep-between-sec N] [--reports-dir DIR] [--stability-summary-json PATH] [--stability-check-summary-json PATH] [--summary-json PATH] [--print-summary-json [0|1]] [--fail-on-no-go [0|1]]
  ...
  ./scripts/easy_node.sh profile-default-gate-token-probe --directory-url URL --issuer-url URL --exit-url URL --campaign-subject INVITE_KEY [--allow-insecure-remote-http [0|1]] [--reports-dir DIR] [--connect-timeout-sec N] [--max-time-sec N] [--summary-json PATH] [--print-summary-json [0|1]] [--show-json [0|1]]
  ...
  ./scripts/easy_node.sh blockchain-mainnet-activation-real-evidence-run [blockchain_mainnet_activation_real_evidence_run args...]
  ...
  ./scripts/easy_node.sh roadmap-next-actions-run [--max-actions N] [--action-timeout-sec N] [--parallel [0|1]] [--local-only [0|1]] [--allow-profile-default-gate-unreachable [0|1]] [--profile-default-gate-subject ID] [--access-recovery-helper-public-dns HOST] [--access-recovery-helper-id ID] [--access-recovery-org-id ID] [--access-recovery-org-name NAME] [--access-recovery-private-code-file PATH] [--access-recovery-bridge-service-config PATH] [--access-recovery-bridge-deploy-pack DIR] [--access-recovery-provenance-private-key-file PATH] [--access-recovery-reports-dir DIR] [--access-recovery-install-dir DIR] [--access-recovery-systemd-unit-file PATH] [--access-recovery-proxy-kind caddy|nginx|none] [--access-recovery-proxy-config-file PATH] [--access-recovery-trust-store PATH] [--access-recovery-mtls-ca PATH] [--access-recovery-mtls-client-cert PATH] [--access-recovery-mtls-client-key PATH] [--include-id ID] [--exclude-id ID] [--include-id-prefix PREFIX] [--exclude-id-prefix PREFIX] [--include-id-suffix SUFFIX] [--exclude-id-suffix SUFFIX] [roadmap_next_actions_run args...]
  ./scripts/easy_node.sh roadmap-evidence-pack-actionable-run [--reports-dir DIR] [--summary-json PATH] [--roadmap-summary-json PATH] [--roadmap-report-md PATH] [--live-evidence-summary-json PATH] [--require-live-derived-evidence-pack-actions [0|1]] [--action-timeout-sec N] [--allow-unsafe-shell-commands [0|1]] [--refresh-manual-validation [0|1]] [--refresh-single-machine-readiness [0|1]] [--scope auto|all|profile-default|runtime-actuation|multi-vm] [--parallel [0|1]] [--max-actions N] [--print-summary-json [0|1]]
  ./scripts/easy_node.sh roadmap-live-evidence-actionable-run [--reports-dir DIR] [--summary-json PATH] [--roadmap-summary-json PATH] [--roadmap-report-md PATH] [--action-timeout-sec N] [--allow-unsafe-shell-commands [0|1]] [--refresh-manual-validation [0|1]] [--refresh-single-machine-readiness [0|1]] [--scope auto|all|profile-default|runtime-actuation|multi-vm] [--parallel [0|1]] [--max-actions N] [--print-summary-json [0|1]]
  ./scripts/easy_node.sh roadmap-live-and-pack-actionable-run [--reports-dir DIR] [--summary-json PATH] [--roadmap-summary-json PATH] [--roadmap-report-md PATH] [--run-live-archive [0|1]] [--archive-root DIR] [--action-timeout-sec N] [--allow-unsafe-shell-commands [0|1]] [--refresh-manual-validation [0|1]] [--refresh-single-machine-readiness [0|1]] [--scope auto|all|profile-default|runtime-actuation|multi-vm] [--parallel [0|1]] [--max-actions N] [--continue-on-live-fail [0|1]] [--print-summary-json [0|1]]
...
Usage:
  ...
  ./scripts/easy_node.sh profile-compare-local [--profiles CSV] [--rounds N] [--timeout-sec N] [--execution-mode docker|local] [--directory-urls URL[,URL...]] [--bootstrap-directory URL] [--issuer-url URL] [--entry-url URL] [--exit-url URL] [--subject ID|--anon-cred TOKEN] [--min-sources N] [--min-entry-operators N] [--min-exit-operators N] [--require-cross-operator-pair [0|1]] [--beta-profile [0|1]] [--prod-profile [0|1]] [--allow-insecure-remote-http [0|1]] [--start-local-stack auto|0|1] [--force-stack-reset [0|1]] [--stack-strict-beta [0|1]] [--base-port N] [--client-iface IFACE] [--exit-iface IFACE] [--cleanup-ifaces [0|1]] [--keep-stack [0|1]] [--fail-on-run-fail [0|1]] [--live-evidence [0|1]] [--live-evidence-udp-inject [0|1]] [--summary-json PATH] [--report-md PATH] [--print-summary-json [0|1]]
  ...
  ./scripts/easy_node.sh profile-compare-campaign [--campaign-runs N] [--campaign-pause-sec N] [--reports-dir DIR] [--profiles CSV] [--rounds N] [--timeout-sec N] [--execution-mode docker|local] [--directory-urls URL[,URL...]] [--bootstrap-directory URL] [--issuer-url URL] [--entry-url URL] [--exit-url URL] [--subject ID|--anon-cred TOKEN] [--min-sources N] [--min-entry-operators N] [--min-exit-operators N] [--require-cross-operator-pair [0|1]] [--beta-profile [0|1]] [--prod-profile [0|1]] [--allow-insecure-remote-http [0|1]] [--start-local-stack auto|0|1] [--force-stack-reset [0|1]] [--stack-strict-beta [0|1]] [--base-port N] [--client-iface IFACE] [--exit-iface IFACE] [--cleanup-ifaces [0|1]] [--keep-stack [0|1]] [--live-evidence [0|1]] [--live-evidence-udp-inject [0|1]] [--trend-max-reports N] [--trend-since-hours N] [--trend-min-profile-runs N] [--trend-min-profile-pass-rate-pct N] [--trend-balanced-latency-margin-pct N] [--trend-fail-on-any-fail [0|1]] [--trend-min-decision-rate-pct N] [--summary-json PATH] [--report-md PATH] [--print-summary-json [0|1]]
  ./scripts/easy_node.sh profile-compare-docker-matrix [--dry-run [0|1]] [profile-compare-campaign args...]
  ./scripts/easy_node.sh profile-compare-multi-vm-sweep [profile_compare_multi_vm_sweep args...]
  ./scripts/easy_node.sh profile-compare-multi-vm-reducer [profile_compare_multi_vm_reducer args...]
  ./scripts/easy_node.sh profile-compare-multi-vm-cycle [profile_compare_multi_vm_cycle args...]
...
./scripts/easy_node.sh profile-default-gate-stability-cycle --host-a HOST --host-b HOST [--campaign-subject ID|--subject ID] [--runs N] [--campaign-timeout-sec N] [--campaign-runs N] [--campaign-profile-rounds N] [--campaign-profile-timeout-sec N] [--campaign-require-min-runs-total N] [--campaign-require-min-runs-with-summary N] [--campaign-require-trend-source CSV] [--campaign-execution-mode docker|local] [--campaign-live-evidence [0|1]] [--require-external-live-evidence [0|1]] [--campaign-live-evidence-udp-inject [0|1]] [--allow-remote-http-probe [0|1]] [--sleep-between-sec N] [--reports-dir DIR] [--stability-summary-json PATH] [--stability-check-summary-json PATH] [--summary-json PATH] [--print-summary-json [0|1]] [--fail-on-no-go [0|1]]
  ...
  ./scripts/easy_node.sh three-machine-prod-bundle [--bundle-dir PATH] [--preflight-check [0|1]] [--preflight-timeout-sec N] [--preflight-require-root [0|1]] [--bundle-verify-check [0|1]] [--bundle-verify-show-details [0|1]] [--run-report-json PATH] [--run-report-print [0|1]] [--incident-snapshot-on-fail [0|1]] [--incident-snapshot-include-docker-logs [0|1]] [--incident-snapshot-docker-log-lines N] [--incident-snapshot-timeout-sec N] [--incident-snapshot-compose-project NAME] [--incident-snapshot-attach-artifact PATH]... [--signoff-check [0|1]] [--signoff-require-full-sequence [0|1]] [--signoff-require-wg-validate-ok [0|1]] [--signoff-require-wg-soak-ok [0|1]] [--signoff-require-wg-validate-udp-source [0|1]] [--signoff-require-wg-validate-strict-distinct [0|1]] [--signoff-require-wg-soak-diversity-pass [0|1]] [--signoff-min-wg-soak-selection-lines N] [--signoff-min-wg-soak-entry-operators N] [--signoff-min-wg-soak-exit-operators N] [--signoff-min-wg-soak-cross-operator-pairs N] [--signoff-max-wg-soak-failed-rounds N] [--signoff-max-evidence-age-sec N] [--signoff-show-json [0|1]] [three-machine-prod-gate args...]
  ...
  ./scripts/easy_node.sh roadmap-progress-report [--refresh-manual-validation [0|1]] [--refresh-single-machine-readiness [0|1]] [--manual-validation-summary-json PATH] [--manual-validation-report-md PATH] [--profile-compare-signoff-summary-json PATH] [--single-machine-summary-json PATH] [--vpn-rc-resilience-summary-json PATH] [--phase2-linux-prod-candidate-summary-json PATH] [--phase3-windows-client-beta-summary-json PATH] [--phase4-windows-full-parity-summary-json PATH] [--phase5-settlement-layer-summary-json PATH] [--phase6-cosmos-l1-summary-json PATH] [--phase7-mainnet-cutover-summary-json PATH] [--blockchain-mainnet-activation-gate-summary-json PATH] [--blockchain-bootstrap-governance-graduation-gate-summary-json PATH] [--gpm-wallet-auth-evidence-summary-json PATH] [--access-bridge-service-smoke-summary-json PATH] [--access-bridge-deployment-evidence-summary-json PATH] [--access-bridge-host-install-summary-json PATH] [--access-bridge-pilot-evidence-bundle-verify-summary-json PATH] [--require-access-recovery-evidence [0|1]] [--summary-json PATH] [--report-md PATH] [--print-report [0|1]] [--print-summary-json [0|1]]
  ...
  ./scripts/easy_node.sh prod-gate-check [--bundle-dir PATH] [--run-report-json PATH] [--gate-summary-json PATH] [--require-full-sequence [0|1]] [--require-wg-validate-ok [0|1]] [--require-wg-soak-ok [0|1]] [--require-preflight-ok [0|1]] [--require-bundle-ok [0|1]] [--require-integrity-ok [0|1]] [--require-signoff-ok [0|1]] [--require-incident-snapshot-on-fail [0|1]] [--require-incident-snapshot-artifacts [0|1]] [--incident-snapshot-min-attachment-count N] [--incident-snapshot-max-skipped-count N|-1] [--require-wg-validate-udp-source [0|1]] [--require-wg-validate-strict-distinct [0|1]] [--require-wg-soak-diversity-pass [0|1]] [--min-wg-soak-selection-lines N] [--min-wg-soak-entry-operators N] [--min-wg-soak-exit-operators N] [--min-wg-soak-cross-operator-pairs N] [--max-wg-soak-failed-rounds N] [--max-evidence-age-sec N] [--show-json [0|1]]
  ./scripts/easy_node.sh prod-gate-slo-summary [--run-report-json PATH] [--bundle-dir PATH] [--gate-summary-json PATH] [--wg-validate-summary-json PATH] [--wg-soak-summary-json PATH] [--require-full-sequence [0|1]] [--require-wg-validate-ok [0|1]] [--require-wg-soak-ok [0|1]] [--max-wg-soak-failed-rounds N] [--require-preflight-ok [0|1]] [--require-bundle-ok [0|1]] [--require-integrity-ok [0|1]] [--require-signoff-ok [0|1]] [--require-incident-snapshot-on-fail [0|1]] [--require-incident-snapshot-artifacts [0|1]] [--require-wg-validate-udp-source [0|1]] [--require-wg-validate-strict-distinct [0|1]] [--require-wg-soak-diversity-pass [0|1]] [--min-wg-soak-selection-lines N] [--min-wg-soak-entry-operators N] [--min-wg-soak-exit-operators N] [--min-wg-soak-cross-operator-pairs N] [--max-evidence-age-sec N] [--fail-on-no-go [0|1]] [--show-json [0|1]]
  ./scripts/easy_node.sh prod-gate-slo-trend [--run-report-json PATH]... [--run-report-list FILE] [--reports-dir DIR] [--max-reports N] [--since-hours N] [--require-full-sequence [0|1]] [--require-wg-validate-ok [0|1]] [--require-wg-soak-ok [0|1]] [--max-wg-soak-failed-rounds N] [--require-preflight-ok [0|1]] [--require-bundle-ok [0|1]] [--require-integrity-ok [0|1]] [--require-signoff-ok [0|1]] [--require-incident-snapshot-on-fail [0|1]] [--require-incident-snapshot-artifacts [0|1]] [--require-wg-validate-udp-source [0|1]] [--require-wg-validate-strict-distinct [0|1]] [--require-wg-soak-diversity-pass [0|1]] [--min-wg-soak-selection-lines N] [--min-wg-soak-entry-operators N] [--min-wg-soak-exit-operators N] [--min-wg-soak-cross-operator-pairs N] [--max-evidence-age-sec N] [--fail-on-any-no-go [0|1]] [--min-go-rate-pct N] [--show-details [0|1]] [--show-top-reasons N] [--summary-json PATH] [--print-summary-json [0|1]]
  ./scripts/easy_node.sh prod-gate-slo-alert [--trend-summary-json PATH] [--run-report-json PATH]... [--run-report-list FILE] [--reports-dir DIR] [--max-reports N] [--since-hours N] [--require-full-sequence [0|1]] [--require-wg-validate-ok [0|1]] [--require-wg-soak-ok [0|1]] [--max-wg-soak-failed-rounds N] [--require-preflight-ok [0|1]] [--require-bundle-ok [0|1]] [--require-integrity-ok [0|1]] [--require-signoff-ok [0|1]] [--require-incident-snapshot-on-fail [0|1]] [--require-incident-snapshot-artifacts [0|1]] [--require-wg-validate-udp-source [0|1]] [--require-wg-validate-strict-distinct [0|1]] [--require-wg-soak-diversity-pass [0|1]] [--min-wg-soak-selection-lines N] [--min-wg-soak-entry-operators N] [--min-wg-soak-exit-operators N] [--min-wg-soak-cross-operator-pairs N] [--max-evidence-age-sec N] [--warn-go-rate-pct N] [--critical-go-rate-pct N] [--warn-no-go-count N] [--critical-no-go-count N] [--warn-eval-errors N] [--critical-eval-errors N] [--fail-on-warn [0|1]] [--fail-on-critical [0|1]] [--show-top-reasons N] [--summary-json PATH] [--print-summary-json [0|1]]
  ./scripts/easy_node.sh prod-gate-slo-dashboard [--run-report-json PATH]... [--run-report-list FILE] [--reports-dir DIR] [--max-reports N] [--since-hours N] [--require-full-sequence [0|1]] [--require-wg-validate-ok [0|1]] [--require-wg-soak-ok [0|1]] [--max-wg-soak-failed-rounds N] [--require-preflight-ok [0|1]] [--require-bundle-ok [0|1]] [--require-integrity-ok [0|1]] [--require-signoff-ok [0|1]] [--require-incident-snapshot-on-fail [0|1]] [--require-incident-snapshot-artifacts [0|1]] [--require-wg-validate-udp-source [0|1]] [--require-wg-validate-strict-distinct [0|1]] [--require-wg-soak-diversity-pass [0|1]] [--min-wg-soak-selection-lines N] [--min-wg-soak-entry-operators N] [--min-wg-soak-exit-operators N] [--min-wg-soak-cross-operator-pairs N] [--max-evidence-age-sec N] [--fail-on-any-no-go [0|1]] [--min-go-rate-pct N] [--show-top-reasons N] [--warn-go-rate-pct N] [--critical-go-rate-pct N] [--warn-no-go-count N] [--critical-no-go-count N] [--warn-eval-errors N] [--critical-eval-errors N] [--fail-on-warn [0|1]] [--fail-on-critical [0|1]] [--trend-summary-json PATH] [--alert-summary-json PATH] [--dashboard-md PATH] [--print-dashboard [0|1]] [--print-summary-json [0|1]]
  ...
  ./scripts/easy_node.sh prod-pilot-cohort-quick-signoff [--run-report-json PATH] [--reports-dir PATH] [--check-latest [0|1]] [--check-trend [0|1]] [--check-alert [0|1]] [--require-status-ok [0|1]] [--require-runbook-ok [0|1]] [--require-signoff-attempted [0|1]] [--require-signoff-ok [0|1]] [--require-cohort-signoff-policy [0|1]] [--require-trend-artifact-policy-match [0|1]] [--require-trend-wg-validate-udp-source [0|1]] [--require-trend-wg-validate-strict-distinct [0|1]] [--require-trend-wg-soak-diversity-pass [0|1]] [--min-trend-wg-soak-selection-lines N] [--min-trend-wg-soak-entry-operators N] [--min-trend-wg-soak-exit-operators N] [--min-trend-wg-soak-cross-operator-pairs N] [--require-bundle-created [0|1]] [--require-bundle-manifest [0|1]] [--require-summary-json [0|1]] [--require-summary-status-ok [0|1]] [--require-incident-snapshot-on-fail [0|1]] [--require-incident-snapshot-artifacts [0|1]] [--incident-snapshot-min-attachment-count N] [--incident-snapshot-max-skipped-count N|-1] [--max-duration-sec N] [--max-evidence-age-sec N] [--max-reports N] [--since-hours N] [--fail-on-any-no-go [0|1]] [--min-go-rate-pct N] [--warn-go-rate-pct N] [--critical-go-rate-pct N] [--warn-no-go-count N] [--critical-no-go-count N] [--warn-eval-errors N] [--critical-eval-errors N] [--max-alert-severity OK|WARN|CRITICAL] [--trend-summary-json PATH] [--alert-summary-json PATH] [--signoff-json PATH] [--show-json [0|1]]
  ./scripts/easy_node.sh prod-pilot-cohort-quick-runbook [--bootstrap-directory URL] [--subject ID] [--pre-real-host-readiness [0|1]] [--pre-real-host-readiness-summary-json PATH] [--rounds N] [--pause-sec N] [--continue-on-fail [0|1]] [--require-all-rounds-ok [0|1]] [--max-round-failures N] [--trend-min-go-rate-pct N] [--max-alert-severity OK|WARN|CRITICAL] [--bundle-outputs [0|1]] [--bundle-fail-close [0|1]] [--reports-dir PATH] [--summary-json PATH] [--run-report-json PATH] [--signoff-json PATH] [--trend-summary-json PATH] [--alert-summary-json PATH] [--dashboard-md PATH] [--signoff-max-reports N] [--signoff-since-hours N] [--signoff-max-evidence-age-sec N] [--signoff-fail-on-any-no-go [0|1]] [--signoff-min-go-rate-pct N] [--signoff-require-cohort-signoff-policy [0|1]] [--signoff-require-trend-artifact-policy-match [0|1]] [--signoff-require-trend-wg-validate-udp-source [0|1]] [--signoff-require-trend-wg-validate-strict-distinct [0|1]] [--signoff-require-trend-wg-soak-diversity-pass [0|1]] [--signoff-min-trend-wg-soak-selection-lines N] [--signoff-min-trend-wg-soak-entry-operators N] [--signoff-min-trend-wg-soak-exit-operators N] [--signoff-min-trend-wg-soak-cross-operator-pairs N] [--signoff-require-incident-snapshot-on-fail [0|1]] [--signoff-require-incident-snapshot-artifacts [0|1]] [--signoff-incident-snapshot-min-attachment-count N] [--signoff-incident-snapshot-max-skipped-count N|-1] [--dashboard-enable [0|1]] [--dashboard-fail-close [0|1]] [--dashboard-print [0|1]] [--dashboard-print-summary-json [0|1]] [--show-json [0|1]] [-- <prod-pilot-runbook extra args...>]
  ./scripts/easy_node.sh prod-pilot-cohort-quick [--bootstrap-directory URL] [--subject ID] [--pre-real-host-readiness [0|1]] [--pre-real-host-readiness-summary-json PATH] [--rounds N] [--pause-sec N] [--continue-on-fail [0|1]] [--require-all-rounds-ok [0|1]] [--max-round-failures N] [--trend-min-go-rate-pct N] [--max-alert-severity OK|WARN|CRITICAL] [--bundle-outputs [0|1]] [--bundle-fail-close [0|1]] [--reports-dir PATH] [--summary-json PATH] [--run-report-json PATH] [--signoff-require-trend-artifact-policy-match [0|1]] [--signoff-require-trend-wg-validate-udp-source [0|1]] [--signoff-require-trend-wg-validate-strict-distinct [0|1]] [--signoff-require-trend-wg-soak-diversity-pass [0|1]] [--signoff-min-trend-wg-soak-selection-lines N] [--signoff-min-trend-wg-soak-entry-operators N] [--signoff-min-trend-wg-soak-exit-operators N] [--signoff-min-trend-wg-soak-cross-operator-pairs N] [--signoff-require-incident-snapshot-on-fail [0|1]] [--signoff-require-incident-snapshot-artifacts [0|1]] [--signoff-incident-snapshot-min-attachment-count N] [--signoff-incident-snapshot-max-skipped-count N|-1] [--signoff-max-evidence-age-sec N] [--print-run-report [0|1]] [--show-json [0|1]] [-- <prod-pilot-runbook extra args...>]
...
Notes:
  ...
  - profile-compare-multi-vm-stability-promotion-check evaluates existing multi-VM stability-cycle evidence for promotion readiness (ad hoc/manual input path) and emits one fail-closed GO/NO-GO summary.
  - profile-compare-multi-vm-stability-promotion-cycle is the primary refresh/rerun path: it runs repeated multi-VM stability cycles and then executes promotion-check on the generated cycle-summary list.
  ...
  - profile-default-gate-run wraps profile-compare-campaign-signoff for final optional VPN default-profile gating with A/B endpoint wait-retry preflight and roadmap docker defaults. Auth mode supports invite-key subject flags or anon-credential pass-through flags, rejects mixed subject+anon modes, and defaults two-node live evidence to synthetic opaque transport plus balanced,speed,speed-1hop campaign profiles unless explicitly overridden.
  ...
  - access-recovery-local-evidence-refresh runs a loopback Access Recovery helper rehearsal; add --write-canonical 1 explicitly to write canonical roadmap-ingestion summaries (override with `ACCESS_RECOVERY_LOCAL_EVIDENCE_REFRESH_SCRIPT`).
  - access-recovery-real-helper-evidence-run runs the real public helper HTTPS evidence flow in one operator command: signed pilot evidence bundle, trusted verifier receipt, and roadmap refresh. Use --roadmap-refresh 0 for diagnostics/verifier-only runs; those stop at verifier_ready and skip the roadmap status roll-up, so handoff_authority_complete remains false until roadmap status is synced (override with `ACCESS_RECOVERY_REAL_HELPER_EVIDENCE_RUN_SCRIPT`).
  ...
  - blockchain-mainnet-activation-real-evidence-run wraps the deterministic non-seeded activation evidence helper path and preserves pass-through args.
  ...
  - roadmap-next-actions-run wraps roadmap `next_actions` in one command with optional exact-id, id-prefix, id-suffix, and local-only filtering, per-action timeout, parallel execution controls, optional soft-fail for unreachable profile-default endpoints, explicit profile-default subject override via `--profile-default-gate-subject ID`, Access Recovery operator input overrides for helper/org/code/config/deploy/provenance/reports/install/proxy fields, Access Recovery trusted verifier trust-store override via `--access-recovery-trust-store PATH`, and optional Access Recovery mTLS file inputs via `--access-recovery-mtls-ca PATH`, `--access-recovery-mtls-client-cert PATH`, and `--access-recovery-mtls-client-key PATH`.
  - roadmap-evidence-pack-actionable-run wraps the roadmap evidence-pack actionable helper path, supports `--scope auto|all|profile-default|runtime-actuation|multi-vm` plus live-summary derived action enforcement, and emits `roadmap_evidence_pack_actionable_run_summary` output.
  ...
  - roadmap-live-and-pack-actionable-run wraps the roadmap live+pack actionable helper path, chains live-cycle and pack actions, optionally fail-closes through `--run-live-archive 1` before evidence-pack publish, and emits `roadmap_live_and_pack_actionable_run_summary` output.
  ...
  - ci-phase0 runs the fast Phase-0 simplification/product-surface gate (launcher wiring/runtime, config-v1, local API, public/admin split, desktop guardrails, GPM admin settlement docs, and lightweight Access Recovery examples) with fail-fast behavior.
  ...
  - roadmap-progress-report generates one concise execution report (JSON + markdown) from manual-validation readiness, optionally refreshing single-machine readiness first, and always includes Access Recovery track status, VPN gate status, and the Cosmos-first blockchain-track policy signal.
  ...
  - pilot-runbook wraps machine-C validation + soak + bundle capture and now treats the public no-override path as balanced by default while keeping expert path-policy overrides available; use --record-result 1 to record closed_beta_pilot_signoff for the separate closed-beta readiness lane.
...
desktop_linux_dev() {
  local script="${DESKTOP_LINUX_DEV_SCRIPT:-$ROOT_DIR/scripts/linux/desktop_dev.sh}"
  run_desktop_wrapper_script "$script" "$@"
}
...
blockchain_mainnet_activation_real_evidence_run() {
  local real_evidence_script="${BLOCKCHAIN_MAINNET_ACTIVATION_REAL_EVIDENCE_SCRIPT:-$ROOT_DIR/scripts/blockchain_mainnet_activation_real_evidence_run.sh}"
  if [[ ! -x "$real_evidence_script" ]]; then
    echo "missing helper script: $real_evidence_script"
    exit 2
  fi
  "$real_evidence_script" "$@"
}
...
profile_compare_multi_vm_stability_promotion_cycle() {
  local stability_promotion_cycle_script="${PROFILE_COMPARE_MULTI_VM_STABILITY_PROMOTION_CYCLE_SCRIPT:-$ROOT_DIR/scripts/profile_compare_multi_vm_stability_promotion_cycle.sh}"
  "$stability_promotion_cycle_script" "$@"
}
...
profile_default_gate_stability_run() {
  local profile_default_gate_stability_run_script="${PROFILE_DEFAULT_GATE_STABILITY_RUN_SCRIPT:-$ROOT_DIR/scripts/profile_default_gate_stability_run.sh}"
  "$profile_default_gate_stability_run_script" "$@"
}

profile_default_gate_stability_check() {
  local profile_default_gate_stability_check_script="${PROFILE_DEFAULT_GATE_STABILITY_CHECK_SCRIPT:-$ROOT_DIR/scripts/profile_default_gate_stability_check.sh}"
  "$profile_default_gate_stability_check_script" "$@"
}

profile_default_gate_stability_cycle() {
  local profile_default_gate_stability_cycle_script="${PROFILE_DEFAULT_GATE_STABILITY_CYCLE_SCRIPT:-$ROOT_DIR/scripts/profile_default_gate_stability_cycle.sh}"
...
profile_default_gate_stability_promotion_cycle() {
  local profile_default_gate_stability_promotion_cycle_script="${PROFILE_DEFAULT_GATE_STABILITY_PROMOTION_CYCLE_SCRIPT:-$ROOT_DIR/scripts/profile_default_gate_stability_promotion_cycle.sh}"
  "$profile_default_gate_stability_promotion_cycle_script" "$@"
}
...
profile_default_gate_live() {
  ...
  profile_default_gate_live_passthrough_has_01() {
    local flag="$1"
    local arg
  ...
  if ! profile_default_gate_live_passthrough_has_01 "--campaign-live-evidence"; then
    run_args+=(--campaign-live-evidence 1)
  fi
  if ! profile_default_gate_live_passthrough_has_01 "--require-external-live-evidence"; then
    run_args+=(--require-external-live-evidence 1)
  fi
  if ! profile_default_gate_live_passthrough_has_01 "--campaign-live-evidence-udp-inject"; then
    run_args+=(--campaign-live-evidence-udp-inject 0)
  fi
...
main() {
  ...
  case "$cmd" in
    ...
    desktop-installer)
      shift
      desktop_generic_dispatch desktop-installer desktop_linux_installer desktop_windows_installer "$@"
      ;;
    ...
    profile-default-gate-stability-promotion-check)
      ...
      profile_default_gate_stability_promotion_check "$@"
      ;;
    profile-default-gate-stability-promotion-cycle)
      shift
      profile_default_gate_stability_promotion_cycle "$@"
      ;;
    ...
    profile-default-gate-token-probe)
      ...
      profile_default_gate_token_probe "$@"
      ;;
    gpm-endpoint-posture-remediate)
      shift
      gpm_endpoint_posture_remediate "$@"
      ;;
    gpm-gap-scan)
