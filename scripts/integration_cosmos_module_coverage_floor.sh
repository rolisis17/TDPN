...
FLOOR_VPNVALIDATOR="${COSMOS_MODULE_COVERAGE_FLOOR_VPNVALIDATOR_MODULE:-$DEFAULT_FLOOR}"
FLOOR_VPNGOVERNANCE="${COSMOS_MODULE_COVERAGE_FLOOR_VPNGOVERNANCE_MODULE:-$DEFAULT_FLOOR}"
...
for floor_name in \
  ...
  "COSMOS_MODULE_COVERAGE_FLOOR_VPNSPONSOR_MODULE:$FLOOR_VPNSPONSOR" \
  "COSMOS_MODULE_COVERAGE_FLOOR_VPNVALIDATOR_MODULE:$FLOOR_VPNVALIDATOR" \
  "COSMOS_MODULE_COVERAGE_FLOOR_VPNGOVERNANCE_MODULE:$FLOOR_VPNGOVERNANCE"; do
  key="${floor_name%%:*}"
  val="${floor_name#*:}"
...
declare -A floors=(
  ...
  ["./x/vpnvalidator/module"]="$FLOOR_VPNVALIDATOR"
  ["./x/vpngovernance/module"]="$FLOOR_VPNGOVERNANCE"
)
