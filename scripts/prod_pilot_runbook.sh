...
dashboard_max_evidence_age_sec="${PROD_PILOT_SLO_DASHBOARD_MAX_EVIDENCE_AGE_SEC:-${PROD_GATE_SLO_MAX_EVIDENCE_AGE_SEC:-600}}"
...
int_or_die "PROD_PILOT_SLO_DASHBOARD_MAX_EVIDENCE_AGE_SEC" "$dashboard_max_evidence_age_sec"
...
if [[ "$dashboard_enable" == "1" ]]; then
  ...
  dashboard_cmd=(
    ...
    "--max-evidence-age-sec" "$dashboard_max_evidence_age_sec"
