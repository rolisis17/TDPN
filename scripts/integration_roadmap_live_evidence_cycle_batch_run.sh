...
# Keep this integration hermetic: ambient batch env overrides can silently
# bypass unresolved-input fail-closed paths and skew expected RC assertions.
unset ROADMAP_LIVE_EVIDENCE_CYCLE_BATCH_PROFILE_COMPARE_MULTI_VM_STABILITY_PROMOTION_CYCLE_SCRIPT
unset ROADMAP_LIVE_EVIDENCE_CYCLE_BATCH_PROFILE_DEFAULT_GATE_STABILITY_CYCLE_SCRIPT
unset ROADMAP_LIVE_EVIDENCE_CYCLE_BATCH_RUNTIME_ACTUATION_PROMOTION_CYCLE_SCRIPT
unset ROADMAP_LIVE_EVIDENCE_CYCLE_BATCH_RUN_CONTINUE_ON_FAIL
unset ROADMAP_LIVE_EVIDENCE_CYCLE_BATCH_RUN_FAILURE_LOG_TAIL_LINES
unset ROADMAP_LIVE_EVIDENCE_CYCLE_BATCH_RUN_ITERATIONS
unset ROADMAP_LIVE_EVIDENCE_CYCLE_BATCH_RUN_PARALLEL
unset ROADMAP_LIVE_EVIDENCE_CYCLE_BATCH_RUN_PRINT_SUMMARY_JSON
unset ROADMAP_LIVE_EVIDENCE_CYCLE_BATCH_RUN_REPORTS_DIR
unset ROADMAP_LIVE_EVIDENCE_CYCLE_BATCH_RUN_ROADMAP_PROGRESS_SUMMARY_JSON
unset ROADMAP_LIVE_EVIDENCE_CYCLE_BATCH_RUN_SUMMARY_JSON
unset A_HOST
unset B_HOST
unset CAMPAIGN_SUBJECT
unset INVITE_KEY
unset PROFILE_COMPARE_MULTI_VM_STABILITY_RUN_VM_COMMAND_FILE
unset PROFILE_COMPARE_MULTI_VM_STABILITY_VM_COMMAND_FILE
unset PROFILE_COMPARE_MULTI_VM_VM_COMMAND_FILE
