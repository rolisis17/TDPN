...
generated_checks=(
  ...
  "$CHAIN_DIR/proto/gen/go/tdpn/vpnslashing/v1/tx.pb.go:MsgConfirmEvidenceRequest"
  "$CHAIN_DIR/proto/gen/go/tdpn/vpnslashing/v1/tx.pb.go:MsgConfirmEvidenceResponse"
  "$CHAIN_DIR/proto/gen/go/tdpn/vpnslashing/v1/tx_grpc.pb.go:ConfirmEvidence"
