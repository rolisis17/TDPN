...
if ! jq -e '.decision == "GO" and .status == "ok" and .rc == 0 and .inputs.policy.require_micro_relay_quality_evidence == true and .inputs.policy.require_micro_relay_quality_status_pass == true and .inputs.policy.require_micro_relay_demotion_policy == true and .inputs.policy.require_micro_relay_promotion_policy == true and .inputs.policy.require_trust_tier_port_unlock_policy == true and .observed.micro_relay_policy_evidence.quality_evidence_present == true and .observed.micro_relay_policy_evidence.quality_status_pass == true and .observed.micro_relay_policy_evidence.demotion_policy_present == true and .observed.micro_relay_policy_evidence.promotion_policy_present == true and .observed.micro_relay_policy_evidence.trust_tier_port_unlock_policy_present == true and (.decision_diagnostics.m4_policy.unmet_requirements | length) == 0 and .decision_diagnostics.m4_policy.gate_summary.required_total == 5 and .decision_diagnostics.m4_policy.gate_summary.required_passed == 5 and .decision_diagnostics.m4_policy.gate_summary.required_failed == 0 and (.decision_diagnostics.m4_policy.gate_summary.failed_gate_ids | length) == 0 and .decision_diagnostics.m4_policy.gate_evaluation.micro_relay_quality_evidence.status == "pass" and .decision_diagnostics.m4_policy.gate_evaluation.trust_tier_port_unlock_policy.status == "pass"' "$M4_PASS_SUMMARY" >/dev/null 2>&1; then
...
if ! jq -e '.decision == "NO-GO" and .status == "fail" and .rc == 0 and (.decision_diagnostics.m4_policy.unmet_requirements | index("micro_relay_quality_status_not_pass")) != null and (.errors[] | contains("micro-relay quality status must be pass")) and .decision_diagnostics.m4_policy.gate_summary.required_total == 1 and .decision_diagnostics.m4_policy.gate_summary.required_passed == 0 and .decision_diagnostics.m4_policy.gate_summary.required_failed == 1 and .decision_diagnostics.m4_policy.gate_summary.failed_gate_ids == ["micro_relay_quality_status_pass"] and .decision_diagnostics.m4_policy.gate_evaluation.micro_relay_quality_status_pass.status == "fail" and (.decision_diagnostics.m4_policy.gate_evaluation.micro_relay_quality_status_pass.actionable_reason | type) == "string"' "$M4_WARN_SUMMARY" >/dev/null 2>&1; then
