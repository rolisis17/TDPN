...
require_mainnet_activation_gate_go="${PHASE7_MAINNET_CUTOVER_HANDOFF_CHECK_REQUIRE_MAINNET_ACTIVATION_GATE_GO:-1}"
require_bootstrap_governance_graduation_gate_go="${PHASE7_MAINNET_CUTOVER_HANDOFF_CHECK_REQUIRE_BOOTSTRAP_GOVERNANCE_GRADUATION_GATE_GO:-1}"
...
require_cosmos_app_coverage_floor_ok="${PHASE7_MAINNET_CUTOVER_HANDOFF_CHECK_REQUIRE_COSMOS_APP_COVERAGE_FLOOR_OK:-1}"
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    --require-tdpnd-grpc-auth-live-smoke-ok)
      ...
      ;;
    --require-tdpnd-comet-runtime-smoke-ok|--require-tdpnd-comet-smoke-ok)
      if [[ $# -ge 2 && ( "${2:-}" == "0" || "${2:-}" == "1" ) ]]; then
...
cosmos_app_coverage_floor_pair="$(resolve_run_signal "cosmos_app_coverage_floor_ok" "$phase7_run_summary_json" "$phase7_run_summary_usable" "$phase7_check_summary_json" "$phase7_check_summary_usable")"
...
mainnet_activation_gate_ok="${mainnet_activation_gate_pair%%|*}"; mainnet_activation_gate_pair="${mainnet_activation_gate_pair#*|}"
...
cosmos_module_coverage_floor_source="${cosmos_module_coverage_floor_pair%%|*}"; cosmos_module_coverage_floor_resolved="${cosmos_module_coverage_floor_pair##*|}"
...
cosmos_keeper_coverage_floor_source="${cosmos_keeper_coverage_floor_pair%%|*}"; cosmos_keeper_coverage_floor_resolved="${cosmos_keeper_coverage_floor_pair##*|}"
...
cosmos_app_coverage_floor_source="${cosmos_app_coverage_floor_pair%%|*}"; cosmos_app_coverage_floor_resolved="${cosmos_app_coverage_floor_pair##*|}"
  ...
  '{
    ...
    inputs: {
      ...
      requirements: {
        ...
        cosmos_app_coverage_floor_ok: ($require_cosmos_app_coverage_floor_ok == 1),
    ...
    handoff: {
      ...
      cosmos_module_coverage_floor_status: $cosmos_module_coverage_floor_status,
      cosmos_module_coverage_floor_resolved: ($cosmos_module_coverage_floor_resolved == 1),
      cosmos_keeper_coverage_floor_ok: $cosmos_keeper_coverage_floor_ok,
      cosmos_keeper_coverage_floor_status: $cosmos_keeper_coverage_floor_status,
      cosmos_keeper_coverage_floor_resolved: ($cosmos_keeper_coverage_floor_resolved == 1),
      cosmos_app_coverage_floor_ok: $cosmos_app_coverage_floor_ok,
      cosmos_app_coverage_floor_status: $cosmos_app_coverage_floor_status,
      cosmos_app_coverage_floor_resolved: ($cosmos_app_coverage_floor_resolved == 1),
      ...
      sources: {
        ...
        cosmos_app_coverage_floor_ok: $cosmos_app_coverage_floor_source,
