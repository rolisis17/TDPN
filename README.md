...
- `go run ./cmd/gpmrecover bridge-registry-upsert-helper --helper-registry .easy-node-logs/access-recovery-demo/bridge-helper-registry.json --helper-id helper-second --org-ids freenews-demo --display-name "Second helper" --contact-url https://helper2.example/contact` (add/update helper registry entries without hand-editing JSON)
