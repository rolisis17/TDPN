...
- `./scripts/easy_node.sh access-recovery-local-evidence-refresh --write-canonical 1 --refresh-roadmap 1 --print-summary-json 1` (local loopback Access Recovery rehearsal that writes canonical roadmap evidence; real pilot handoff still requires helper HTTPS evidence plus a trusted verifier receipt bound to the verified bundle evidence hashes)
