...
- in live WG mode (`CLIENT_LIVE_WG_MODE=1`, `EXIT_LIVE_WG_MODE=1`), sink/source addresses are mandatory, client/exit drop opaque payloads that fail WireGuard framing + minimum-length checks, and raw downlink source packets must be session-framed
