...
- `go run ./cmd/gpmrecover bridge-service-deploy-pack --out-dir .easy-node-logs/access-recovery-demo/bridge-deploy --access-code-sha256 HASH` (generate env, run-wrapper, and hardened systemd unit files for a helper bridge)
