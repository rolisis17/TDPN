...
- `bash ./scripts/access_bridge_service_smoke.sh --base-url https://bridge.example --path-id helper-web --code CODE --summary-json .easy-node-logs/bridge-service-smoke.json` (operator smoke for a deployed helper bridge)
