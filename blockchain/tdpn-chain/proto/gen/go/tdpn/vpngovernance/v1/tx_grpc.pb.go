...
func (c *msgClient) CreatePolicy(ctx context.Context, in *MsgCreatePolicyRequest, opts ...grpc.CallOption) (*MsgCreatePolicyResponse, error) {
...
func (c *msgClient) RecordDecision(ctx context.Context, in *MsgRecordDecisionRequest, opts ...grpc.CallOption) (*MsgRecordDecisionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MsgRecordDecisionResponse)
	err := c.cc.Invoke(ctx, Msg_RecordDecision_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) CreatePolicy(context.Context, *MsgCreatePolicyRequest) (*MsgCreatePolicyResponse, error) {
...
func _Msg_CreatePolicy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).CreatePolicy(ctx, req.(*MsgCreatePolicyRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Msg_RecordDecision_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgRecordDecisionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).RecordDecision(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_RecordDecision_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).RecordDecision(ctx, req.(*MsgRecordDecisionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Msg_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tdpn.vpngovernance.v1.Msg",
	...
	Metadata: "tdpn/vpngovernance/v1/tx.proto",
}
