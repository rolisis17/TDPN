...
## Why this shape
Client and server igit statun one program allowing the user to be part of the network as provider and also as client. The current scaffold is built exactly that way: role flags enable any combination in one process.
