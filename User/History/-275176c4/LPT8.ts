...
import { getKeypairFromEnvironment } from "@solana-developers/helpers";
  ...
  (async () => {
    ...
    const newMetadata: DataV2 = {
      ...
      uri: "Qmeg7XTHf7eucVb449zedcWwX516WqbQDPROGRAM_ID as TOKEN_METADATA_PROGRAM_ID,71HUf3Bv3siv6",
    ...
    const updateInstruction = createUpdateMetadataAccountV2Instruction(
      {
        metadata: metadataAccount,PROGRAM_ID as TOKEN_METADATA_PROGRAM_ID,
