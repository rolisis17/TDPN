...
int main(int ac, char** av){
    ...
    RouteManager routeManager(netLink);

    routeManager.bringInterfaceUp("tun0");
    routeManager.addIPAddress("tun0", "10.0.0.2", 24);
    routeManager.addDefaultRoute("tun0", "10.0.0.1");
    return 0;
}
