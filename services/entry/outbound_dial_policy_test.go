...
func TestResolveSafeDialAddressRejectsPrivateDNSAddress(t *testing.T) {
	...
	target, err := resolveSafeDialAddress(
		...
		stubOutboundResolver{addrs: map[string][]net.IPAddr{
			"exit.example": {{IP: net.ParseIP("10.10.10.10")}},
		}},
		"exit.example:443",
		false,
		false,
...
func TestResolveSafeDialAddressAllowsLiteralLoopback(t *testing.T) {
	...
	target, err := resolveSafeDialAddress(context.Background(), stubOutboundResolver{}, "127.0.0.1:8084", false, true)
	if err != nil {
...
func TestResolveSafeDialAddressRejectsZoneIdentifierHost(t *testing.T) {
	...
	_, err := resolveSafeDialAddress(context.Background(), stubOutboundResolver{}, "[fe80::1%eth0]:8084", false, false)
	if err == nil {
...
func TestResolveSafeDialAddressBlocksLiteralPrivateIPByDefault(t *testing.T) {
	...
	_, err := resolveSafeDialAddress(context.Background(), stubOutboundResolver{}, "10.0.0.9:8084", false, false)
	if err == nil {
...
func TestResolveSafeDialAddressBlocksLiteralCGNATIPByDefault(t *testing.T) {
	...
	_, err := resolveSafeDialAddress(context.Background(), stubOutboundResolver{}, "100.64.0.9:8084", false, false)
	if err == nil {
...
func TestResolveSafeDialAddressDangerousOverrideAllowsPrivateDNS(t *testing.T) {
	...
	target, err := resolveSafeDialAddress(
		context.Background(),
		stubOutboundResolver{addrs: map[string][]net.IPAddr{
			"peer.internal.example": {{IP: net.ParseIP("10.1.2.3")}},
		}},
		"peer.internal.example:8443",
		true,
		false,
	)
	if err != nil {
...
func TestResolveSafeDialAddressStrictModeBlocksLiteralPrivateIP(t *testing.T) {
	...
	_, err := resolveSafeDialAddress(context.Background(), stubOutboundResolver{}, "10.0.0.9:8084", false, true)
	if err == nil {
...
func TestResolveSafeDialAddressStrictModeBlocksLiteralPrivateIPEvenWithDangerousOverride(t *testing.T) {
	...
	_, err := resolveSafeDialAddress(context.Background(), stubOutboundResolver{}, "10.0.0.9:8084", true, true)
	if err == nil {
