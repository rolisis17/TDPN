...
- `access_bridge_service_smoke.sh` records deployed bridge health, observed transport/TLS facts, access-code-gated path availability, helper/org/registry identity, security headers, and abuse endpoint acceptance into a JSON summary
