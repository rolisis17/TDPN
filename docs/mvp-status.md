...
- Runtime strict-mode hardening: entry and directory now fail-closed on default/weak runtime secrets (`ENTRY_PUZZLE_SECRET`, `DIRECTORY_ADMIN_TOKEN`) in beta/prod strict mode.
