...
- Phase 6 contracts CI gate includes `cosmos_module_coverage_floor` wired to `scripts/integration_cosmos_module_coverage_floor.sh` as part of the phase6 contracts posture before wrapper handoff/run stages.
