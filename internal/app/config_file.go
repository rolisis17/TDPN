...
var blockedGenericConfigFileEnvKeys = map[string]struct{}{
	...
	"LOCAL_CONTROL_API_GIT_BASH_PATH":                    {},
	"LOCAL_CONTROL_API_BRIDGE_COMMAND_RUNNER":            {},
	"LOCAL_CONTROL_API_BRIDGE_ALLOW_RUNNER_ENV_OVERRIDE": {},
	"LOCAL_CONTROL_API_BRIDGE_ALLOW_UNTRUSTED_RUNNER":    {},
...
func applyPathProfileFromConfigV1(raw string) (string, string, error) {
	...
	case "1hop":
		...
		setEnvIfUnset("CLIENT_ENTRY_ROTATION_SEC", "120")
		setEnvIfUnset("CLIENT_ENTRY_ROTATION_JITTER_PCT", "20")
		setEnvIfUnset("CLIENT_EXIT_EXPLORATION_PCT", "20")
	case "3hop":
		...
		setEnvIfUnset("CLIENT_STICKY_PAIR_SEC", "420")
		setEnvIfUnset("CLIENT_ENTRY_ROTATION_SEC", "240")
		setEnvIfUnset("CLIENT_ENTRY_ROTATION_JITTER_PCT", "10")
		setEnvIfUnset("CLIENT_EXIT_EXPLORATION_PCT", "5")
	default:
		setEnvIfUnset("CLIENT_REQUIRE_DISTINCT_OPERATORS", "1")
		setEnvIfUnset("CLIENT_REQUIRE_DISTINCT_ENTRY_EXIT_COUNTRY", "0")
		setEnvIfUnset("CLIENT_ALLOW_DIRECT_EXIT_FALLBACK", "0")
		setEnvIfUnset("CLIENT_FORCE_DIRECT_EXIT", "0")
		setEnvIfUnset("CLIENT_STICKY_PAIR_SEC", "300")
		setEnvIfUnset("CLIENT_ENTRY_ROTATION_SEC", "180")
