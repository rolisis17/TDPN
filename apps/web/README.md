...
- Wallet verification currently uses challenge+signature contract wiring with daemon-side guardrails and a pluggable verifier hook; full wallet extension signature verification remains a follow-on milestone.
